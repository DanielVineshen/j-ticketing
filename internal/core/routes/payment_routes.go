...
func PostToZooAPI(order *models.OrderTicketGroup, orderNo string, orderTicketInfoRepo repositories.OrderTicketInfoRepository) ([]email.OrderInfo, []email.TicketInfo, error) {
